    ...
    return "\n".join(
        [
            ...
            *resource_setup,
            ...
            "disp(evalin('base', 'photostimTrialPulseWidthSec'));",
            "disp('Waveform task total duration sec:');",
            "disp(evalin('base', 'photostimTrialTotalDurationSec'));",
            ...
            "disp('Waveform task active after run:');",
            "if most.idioms.isValidObj(wg.hTask); disp(double(wg.hTask.active)); else; disp(0); end",
            "disp('Waveform task done after run:');",
            "if most.idioms.isValidObj(wg.hTask); disp(double(wg.hTask.isTaskDone())); else; disp(1); end",
            "if hPs.active;",
            "    pause(0.2);",
