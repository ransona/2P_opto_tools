...
def build_trigger_photostim_command(
    ...
    lines = [
        ...
        "precomposedTrialCount = 5;",
        "trialTail = repmat(trialTailSingle(:).', 1, precomposedTrialCount);",
        ...
        "disp(1);",
        "disp('TRIGGER_PHOTOSTIM_PRECOMPOSED_TRIALS');",
        "disp(double(precomposedTrialCount));",
        "drawnow();",
        "pause(3.0);",
