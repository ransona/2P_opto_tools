...
def build_trigger_photostim_command(
    ...
    lines = [
        ...
        "disp('TRIGGER_PHOTOSTIM_REUSED_EXISTING_TAIL');",
        "disp(double(reuseExistingTail));",
        "hPs.numSequences = 1;",
        "if isprop(hPs,'stimImmediately'); hPs.stimImmediately = false; end",
        "if ~hPs.active;",
            "    hPs.start();",
