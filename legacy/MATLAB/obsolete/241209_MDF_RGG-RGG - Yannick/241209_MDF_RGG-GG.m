...
amplitudeToLinePhaseMap = [1.19 -1.8048e-06;1.316 -1.8816e-06;1.786 -2.112e-06;1.923 -2.2144e-06;2.5 -2.3168e-06;4.167 -2.5344e-06;4.8 -2.5344e-06;5 -2.5728e-06;8.333 -2.6496e-06;24 -2.7264e-06;25 -2.8032e-06];     % translates an amplitude (degrees) to a line phase (seconds)
amplitudeToFrequencyMap = [2.083 7924.12;2.5 7921.72;3.25 7923.28;3.789 7923.12;5.2 7922.66;6.909 7920.34;8 7921.19;18.147 7915.07;19.36 7919.19;21.774 7918.6;23.473 7916.01;23.638 7919.4;23.679 7915.3;24 7923.01;25 7920.74;25.999 7920.34;26 7919.65];     % translates an amplitude (degrees) to a resonant frequency (Hz)
...
% Calibration Settings
amplitudeToLinePhaseMap = [2.6 -2.816e-07;3 -3.968e-07;3.429 -3.584e-07;4 -4.48e-07;4.8 -2.432e-07;6 -4.608e-07;8 -5.504e-07;8.667 -5.504e-07;14.712 -5.888e-07;24 -6.528e-07;26 -6.144e-07];     % translates an amplitude (degrees) to a line phase (seconds)
amplitudeToFrequencyMap = [2.6 7918.94;2.615 7922.26;3 7919.64;3.429 7919.94;3.433 7921.74;4 7918.97;4.74 7921.03;4.8 7918.63;5.231 7921.15;5.435 7918.99;5.556 7920.79;6 7914.46;6.175 7920.56;6.5 7917.7;7.111 7920.15;8 7920.84;8.667 7917.81;13.567 7920.53;14.712 7917.96;20.392 7917.64;23.473 7910.28;24 7913.97;26 7914.06];     % translates an amplitude (degrees) to a resonant frequency (Hz)
amplitudeLUT = zeros(0,2);     % translates a nominal amplitude (degrees) to an output amplitude (degrees)
...
powerFraction2PowerWattLut = [0 0;1 0.33];
...
powerFraction2PowerWattLut = [0 0;1 0.39];
...
powerFraction2PowerWattLut = [0 0;1 0.188];
...
autoOn = false;     % powers the PMT automatically on for the duration of a scan
gain_V = 0.2;     % PMT power supply voltage
...
externalSampleClock = true;     % Logical: use external sample clock connected to the CLK IN terminal of the FlexRIO digitizer module
externalSampleClockRate = 7.98e+07;     % [Hz]: nominal frequency of the external sample clock connected to the CLK IN terminal (e.g. 80e6); actual rate is measured on FPGA
externalSampleClockMultiplier = 32;     % Multiplier to apply to external sample clock
useCustomFilterClock = false;
customFilterClockPeriod = 32;
sampleClockPhase = [];     % Phase delay to apply to sample clock
...
% Calibration data
scannerToRefTransform = [1 0 -0.689154;0 1 -1.8521;0 0 1];
LaserTriggerDebounceTicks = 1;
virtualChannelsSource = {'AI0' 'AI1' 'AI0' 'AI1'};
virtualChannelsMode = {'analog' 'analog' 'analog' 'analog'};
virtualChannelsThreshold = [false false false false];
