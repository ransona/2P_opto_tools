...
amplitudeToLinePhaseMap = [1.19 -1.8048e-06;1.316 -1.8816e-06;1.786 -2.112e-06;1.923 -2.2144e-06;2.5 -2.3168e-06;4.167 -2.5344e-06;5 -2.5728e-06;8.333 -2.6496e-06;25 -2.8032e-06;26 -2.8416e-06];     % translates an amplitude (degrees) to a line phase (seconds)
amplitudeToFrequencyMap = [2.083 7924.12;2.5 7921.72;3.789 7923.12;19.36 7919.19;23.473 7916.01;23.638 7919.4;23.679 7915.3;25 7920.74;25.999 7920.34;26 7919.65];     % translates an amplitude (degrees) to a resonant frequency (Hz)
...
gain_V = 0;     % PMT power supply voltage
...
externalSampleClockMultiplier = 20;     % Multiplier to apply to external sample clock
...
%% scanimage.components.scan2d.RggScan (GG_P2)

acquisitionDeviceId = 'vDAQ0';     % RDI Device ID
acquisitionEngineIdx = 1;

resonantScanner = '';     % Name of the resonant scanner
