...
amplitudeToLinePhaseMap = [1.19 -1.8048e-06;1.316 -1.8816e-06;1.786 -2.112e-06;1.923 -2.2144e-06;2.4 -2.28137e-06;2.5 -2.3168e-06;3.429 -2.42079e-06;4.167 -2.5344e-06;4.8 -2.5344e-06;5 -2.5728e-06;8.333 -2.6496e-06;24 -2.7264e-06;25 -2.8032e-06];     % translates an amplitude (degrees) to a line phase (seconds)
amplitudeToFrequencyMap = [2.083 7924.12;2.4 7918.36;2.5 7921.72;3 7922.43;3.25 7923.28;3.429 7920.44;3.789 7923.12;5.2 7922.66;6.909 7920.34;8 7921.19;18.147 7915.07;19.36 7919.19;21.774 7918.6;23.473 7916.01;23.638 7919.4;23.679 7915.3;24 7923.01;25 7920.74;25.999 7920.34;26 7919.65];     % translates an amplitude (degrees) to a resonant frequency (Hz)
...
voltsOffset = 0.7;     % voltage to be added to the output
...
% Calibration Settings
amplitudeToLinePhaseMap = [1.333 -5.06971e-08;2.6 -2.816e-07;2.667 -3.16857e-07;3 -4.352e-07;3.429 -3.584e-07;4 -4.81622e-07;4.8 -2.432e-07;6 -4.608e-07;8 -5.504e-07;8.667 -5.504e-07;14.712 -5.888e-07;24 -6.528e-07;26 -6.144e-07];     % translates an amplitude (degrees) to a line phase (seconds)
amplitudeToFrequencyMap = [1.333 7920.57;2.6 7918.94;2.615 7922.26;2.667 7916.58;3 7919.64;3.429 7919.94;3.433 7921.74;4 7918.97;4.74 7921.03;4.8 7918.63;5.231 7921.15;5.435 7918.99;5.556 7920.79;6 7914.46;6.175 7920.56;6.5 7917.7;7.111 7920.15;8 7920.84;8.667 7917.81;12 7909.77;13.567 7920.53;14.712 7917.96;20.392 7917.64;23.473 7910.28;24 7913.97;26 7914.06];     % translates an amplitude (degrees) to a resonant frequency (Hz)
amplitudeLUT = zeros(0,2);     % translates a nominal amplitude (degrees) to an output amplitude (degrees)
...
% Calibration settings
feedbackVoltLUT = [-2.32207 -5.61;-1.80705 -4.36333;-1.2887 -3.11667;-0.774976 -1.87;-0.259186 -0.623333;0.257996 0.623333;0.774951 1.87;1.2916 3.11667;1.80804 4.36333;2.32291 5.61];     % [Nx2] lut translating feedback volts into position volts
offsetVoltScaling = 1;     % scalar factor for offset volts
...
% Calibration settings
feedbackVoltLUT = [-1.98141 -4.9;-1.48716 -3.67778;-0.992047 -2.45556;-0.498206 -1.23333;-0.0043457 -0.0111111;0.490854 1.21111;0.983405 2.43333;1.47802 3.65556;1.97031 4.87778;2.46629 6.1];     % [Nx2] lut translating feedback volts into position volts
offsetVoltScaling = 1;     % scalar factor for offset volts
...
powerFraction2PowerWattLut = [0 0;1 0.16];
...
scannerToRefTransform = [1 0 0;0 1 0;0 0 1];
LaserTriggerDebounceTicks = 1;
virtualChannelsSource = {'AI0' 'AI1' 'AI1' 'AI1'};
virtualChannelsMode = {'analog' 'analog' 'photon counting' 'analog'};
virtualChannelsThreshold = [false false false false];
virtualChannelsBinarize = [false false false false];
virtualChannelsEdgeDetect = [false false false false];
virtualChannelsLaserGate = [false true true false];
virtualChannelsDisableDivide = [false false false false];
virtualChannelsThresholdValue = [100 100 100 100];
virtualChannelsLaserFilterWindow = {[0 1] [0 1] [0 1] [0 1]};
...
%% dabs.meadowlark.Slm1024v2 (SLM 1024 v2)
...
%% scanimage.components.scan2d.SlmScan (SLM_1024_ScanSystem)
slm = 'SLM 1024 v2';     % name of the slm in use
...
slmMagnificationOntoGalvos = 1;     % Magnification of SLM onto galvos. E.g. if SLM is demagnified onto galvo by a factor of 4, the value should be 0.25
